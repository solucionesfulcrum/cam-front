...
export class CiramsComponent implements OnInit {
  ...
  constructor(
    ...
    private authService: AuthService 
      ...
      breadcrumService.link1$.next({ url: '/talleres/cirams', title:'CIRAMS' });
  ...
  setLink2(nameLink: string, codigo:string){
      this.breadcrumService.link2$.next({url:'/talleres/cirams/show/'+codigo, title:nameLink});
      this.router.navigate(['/talleres/cirams/show/', codigo]);
  }
