...
export class TalleristasComponent implements OnInit {
  ...
  constructor(
    ...
    private authService: AuthService 
      ...
      breadcrumService.link1$.next({ url: '/talleres/talleristas', title:'TALLERISTAS' });
      breadcrumService.activeTab$.next('talleristas');
  ...
  setLink2(nameLink: string, codigo:string){
      this.breadcrumService.link2$.next({url:'/talleres/talleristas/show/'+codigo, title:nameLink});
      this.router.navigate(['/talleres/talleristas/show/', codigo]);
  }
