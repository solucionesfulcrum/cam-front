...
@Component({
  selector: 'esp-prof-cam-asistencia-rapida',
  templateUrl: './prof-cam-asistencia-rapida.component.html',
  styleUrls: ['./prof-cam-asistencia-rapida.component.scss']
})
export class ProfCamAsistenciaRapidaComponent {
  ...
  imprimirLista(){
    ...
    servicioMetodo.subscribe((data)=>{
      ...
      anchor.download = 'Reporte_Asistencia_Rapida_Profesional_cam.xlsx';
      anchor.href = url;
      anchor.click();
