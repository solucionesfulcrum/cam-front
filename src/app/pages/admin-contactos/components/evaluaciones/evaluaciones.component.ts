...
import { RequestEvaluacionReporte } from '@models/afiliaciones/evaluaciones/evaluacion-evaluar.model';
...
export class EvaluacionesComponent {
  ...
  constructor(private fb                      : FormBuilder, 
              ...
              private evaluacionesService     : AfiliacionesEvaluacionesService,) { }
  ...
  onLoadData(){
    ...
    setTimeout(()=>{
      ...
      let servicioMetodo = this.evaluacionesService.getListaEvaluacionesNacional(this.getPayload());
  ...
  getPayload(): RequestEvaluacionReporte{
    var fecInicio: any;
    var fecFin: any;
  ...
  imprimirLista(){
    ...
    let payload: RequestEvaluacionReporte = {
      idUnidOpe: this.formBuscar.get('frmSearchRed')?.value,
      texto: this.formBuscar.controls['frmSearch'].value,
    ...
    let servicioMetodo = this.evaluacionesService.getExcelEvaluacionesNacional(payload);
