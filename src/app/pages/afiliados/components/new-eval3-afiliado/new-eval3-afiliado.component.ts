...
@Component({
  selector: 'app-new-eval3-afiliado',
  templateUrl: './new-eval3-afiliado.component.html',
  styleUrls: ['./new-eval3-afiliado.component.css']
})
export class NewEval3AfiliadoComponent implements OnInit {
  ...
  onNext(){
    ...
    this.router.navigate(['/afiliados/agregaEval4'])
  }
