...
@Component({
  selector: 'app-new-eval4-afiliado',
  templateUrl: './new-eval4-afiliado.component.html',
  styleUrls: ['./new-eval4-afiliado.component.css']
})
export class NewEval4AfiliadoComponent implements OnInit {
  ...
  onNext(){
    ...
    this.router.navigate(['/afiliados/resultEval'])
  }
