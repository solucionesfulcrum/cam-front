...
@Component({
  selector: 'esp-dashboard-asistencias-programadas',
  templateUrl: './dashboard-asistencias-programadas.component.html',
  styleUrls: ['./dashboard-asistencias-programadas.component.scss']
})
export class DashboardAsistenciasProgramadasComponent {
  ...
  opcionesFiltroTotal: any[] = [
    {value: null, tituloCard: 'Total Sesiones Programadas', rutaIcon: 'icon-dashboard-taller-actividad', totalCalculado: 0},
    {value: 1, tituloCard: 'Total Sesiones Ejecutadas', rutaIcon: 'icon-dashboard-taller-finalizados', totalCalculado: 0},
  ];
