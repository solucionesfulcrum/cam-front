...
export class RegisterAseguradoComponent {
  ...
  ngOnInit(){
      ...
      this._datoGeneralesService.validarAdmisionIngreso(this.tipoDoc, this.numDoc, this.idUnidadOperativaUser, 1, this.fecNac).subscribe((data)=>{
        if (data.code == 0) {
  ...
  getDataAsegurado(): datosAseguradoFicha{
    ...
    const response = {
      ...
      apeMaterno: (this.infoReniec.txtApematcasada? this.infoReniec.txtApematcasada : this.infoReniec.txtApematerno) || "XXXX",
      ...
      codTipoAsegurado: this.dataSeguro.TIPO_ASEGURADO ? this.dataSeguro.TIPO_ASEGURADO[0] : "",
      descTipoAsegurado: this.dataSeguro.TIPO_ASEGURADO,
      codTipoSeguro: this.dataSeguro.DGACTAS ? this.dataSeguro.DGACTAS[0] : "",
      //descTipoSeguro: 'Seguro ' + this.dataSeguro.DGACTAS,
      //descTipoSeguro: this.dataSeguro.TIPO_ASEGURADO,
      descTipoSeguro: this.dataSeguro.DGACTAS,
      autogenerado: this.dataSeguro.DGACAUT,
      condicion: this.dataSeguro.CONDICION,
