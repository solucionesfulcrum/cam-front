...
@Component({
  selector: 'esp-control-tallerista',
  templateUrl: './control-tallerista.component.html',
  styleUrls: ['./control-tallerista.component.scss']
})
export class ControlTalleristaComponent {
  opciones: Parametro[] = [];
