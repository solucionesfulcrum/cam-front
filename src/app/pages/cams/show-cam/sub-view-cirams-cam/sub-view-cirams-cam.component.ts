...
@Component({
  selector: 'app-sub-view-cirams-cam',
  templateUrl: './sub-view-cirams-cam.component.html',
  styleUrls: ['../show-cam.component.css']
})
export class SubViewCiramsCamComponent implements OnInit {
...
constructor(
    ...
    private breadcrumService: BreadcrumService
      ...
      breadcrumService.subLink1$.next({ url: './', title:'CIRAMS'});
