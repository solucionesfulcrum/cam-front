...
export class ContratosAsignarServiciosComponent {
  ...
  dataColumnas: FormatoColumna[] = [
    ...
    {header: 'Servicio', tipo: 'typeAndSelect', placeholder:'Buscar el servicio a contratar', optTypeSelect: this.opcionesServicios, nomAttribute: 'nomServicio', resaltado: true, obligatorio: true},
